...
* local modification; add header about license on every imported `*.table` files under [vendor\mastml\mastml\magpie](src\draftsh\data\miscs\vendor\mastml\mastml\magpie)
